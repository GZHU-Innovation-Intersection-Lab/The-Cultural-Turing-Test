...
def get_file_path(test,country):
    ...
    if(test == "1" or test == "2"):
        file_paths = [
            fr"prompt\CN-test1.txt",
            fr"persona\{country}_persona_{test}.xlsx",
...
def modelTry(test,run,country,model,base_path, api_key: Optional[str] = None, base_url: Optional[str] = None, proxy_url: Optional[str] = None):
    global df
